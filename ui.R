...
shinyUI(fluidPage(theme = shinytheme("spacelab"),
                  ...
                  navbarPage(strong("Cervical Cancer"),
                             ...
                             tabPanel(strong("Upload"),
                                      sidebarPanel(
                                        helpText(a("Click Here for the Source Code on Github!", href = "https://github.com/medxiaorudan/Cervical Cancer/", target = "_blank")),
                                      ...
                                      mainPanel(
                                        ...
                                        plotOutput('plot'),
                                        h2("绿色曲线为千人基因组人群宫颈癌遗传风险值密度曲线，条状热图从绿色到红色表示遗传风险从低到高，上传vcf文件后会以三角形指示您风险值对应的位置",style = "font-family: 'Cyborg', cursive; line-height: 1.1; color: forestgreen;")
                                        ),
